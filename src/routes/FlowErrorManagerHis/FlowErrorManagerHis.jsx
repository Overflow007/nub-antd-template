...
import styles from './FlowErrorManagerHis.scss';
 ...
 */
@observer
class FlowErrorManagerHis extends Component {
	...
	render() {
		...
		url += '/view/flow/flowerror/flowErrorManagerHis.html';
...
export default FlowErrorManagerHis;