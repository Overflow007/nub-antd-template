...
const columns = [{
    ...
    {title:'工作项',dataIndex:'workItemId',width:100,metaContent:true},
    {title:'路由',dataIndex:'route',width:80,metaContent:true},
    {title:'状态',dataIndex:'state',width:80,metaContent:true},
    ...
    {title: '监控信息', dataIndex: 'commandMsg', sorter: true, width:300},
    {title: '详情', dataIndex: 'commandResultMsg', sorter: true, width:300}
  ];
