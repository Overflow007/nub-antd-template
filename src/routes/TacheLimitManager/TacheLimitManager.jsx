...
import styles from './TacheLimitManager.scss';


const PREFIX = 'flow-tachelimitmgr';
 ...
 */
@observer
class TacheLimitManager extends Component {
	...
	render() {
		...
		url += '/view/flow/timelimit/tacheLimitManager.html';
